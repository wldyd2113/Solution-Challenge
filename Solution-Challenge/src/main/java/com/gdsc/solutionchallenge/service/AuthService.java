...
import com.gdsc.solutionchallenge.dto.MemberInfo;
...
public class AuthService {
    ...
    public TokenDto loginOrSignUp(String googleAccessToken) {
        ...
        Member member = userRepository.findByEmail(memberInfo.getEmail()).orElseGet(() ->
                userRepository.save(Member.builder()
                        .email(memberInfo.getEmail())
                        .name(memberInfo.getName())
                        .pictureUrl(memberInfo.getPictureUrl())
